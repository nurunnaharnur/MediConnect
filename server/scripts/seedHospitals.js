...
//
// Seeds sample hospitals and practice doctors with GeoJSON coordinates,
// specialties, ratings, and weekly available time slots.
//
// Usage:
//   node server/scripts/seedHospitals.js
...
const doctorsByHospitalIndex = [
  ...
  [
    ...
    },
    {
      ...
      specialty: 'Psychiatrist / Clinical Psychologist',
      experienceYears: 10,
      rating: 4.4,
